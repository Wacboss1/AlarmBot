...
uint8_t button_getButton() {
	...
	// TODO: Write code below -- Return the right most button position pressed
	
	// INSERT CODE HERE!
    if((GPIO_PORTE_DATA_R & 0b1000) == 0b00000000)
    {
        return 4;
    }
    else if((GPIO_PORTE_DATA_R & 0b100) == 0b00000000)
    {
        return 3;
    }
    else if((GPIO_PORTE_DATA_R & 0b10) == 0b00000000){
        return 2;
    }
