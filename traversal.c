...
#define BORDER_FRONT_LEFT 0x10
#define BORDER_LEFT 0x20
#define BORDER_FRONT_RIGHT 0x40
#define BORDER_RIGHT 0x80
...
int detect_cliff(oi_t *sensor)
{
    ...
    if (return_value == 0)
    {
        ...
        {
            return_value |= BORDER_FRONT_RIGHT;
        }
        if (sensor->cliffFrontLeftSignal > 2600)
        {
            return_value |= BORDER_FRONT_LEFT;
        }
        if (sensor->cliffRightSignal > 2600)
        {
            return_value |= BORDER_RIGHT;
        }
